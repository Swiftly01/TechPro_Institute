  ...
  <div class="modal fade" id="basicModalServiceReject{{ $payment->id }}">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">Are you sure you want to Reject {{ ucfirst(strtolower($payment->client->firstname)) }} {{ ucfirst(strtolower($payment->client->lastname))  }} Payment</div>
