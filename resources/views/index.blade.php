...
<body>
    ...
    <section class="why_techpro_nigeria">
        <div class="container">
            <p class="text-center text-danger   header_text pt-2">Why TechPro
                Nigeria</p>
    ...
    <div class="container">
        <div class="row my-md-2">
            <div class="col">
                <h1 class="text-center text-danger my-4 header_text">Our Available Courses</h1>
        ...
        <div class="row">
            <div class="col">
                <h1 class="text-center text-danger my-3 my-md-4    header_text">Our Services</h1>
                ...
                <div class="row  row-cols-1 row-cols-md-2 row-cols-lg-3 g-5 g-4">
                    <div class="col">
                        <div class="card shadow-lg rounded-lg border card-rad">
                            ...
                            <div style="margin-top: -10px;" class="container">
                                <img height="180px" src="{{ asset('assets/images/DSC_4998.jpg') }}" class="card-img-top"
                                    alt="...">
                                <div>
        ...
        <div class="row mt-4">
            <div class="col">
                <div class="container">
                    ...
                    <p class="fw-light text-center fs-5">Our Goal is to drive social
    ...
    <section class="my-5 py-4" style="background-color: #0A5098; height: auto;">
        <div class="container-fluid">
            <h1 class="text-center py-2" style="font-size: 36px; color: #E4C939;">Our Partners</h1>
