...
<body>
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav mx-auto mb-2 mb-lg-0 mt-2">
                ...
                <li class="nav-item me-5">
                    <a class="nav-link " aria-current="page" href="about-u.html">About-U</a>
                </li>
                <li class="nav-item me-5">
 ...
 <div  class="container">
  <div  class="row main">
    <div class="col">
      <h1 ><a class="text-danger home" href="index.html">Home/</a><a class=" text-danger home" href="services.html">Services/</a><a  class ="text-danger home" href="working.html">Co-Working space</a></h1>
    </div>
  </div>
  <div class="row">
    <div class="col">
 ...
 <div class="container">
  <div class="row no-gutters mt-5">
    <div style="background-color: #105697;" class="col-md-12 col-lg-5">
      ...
      <div class="links">
        <h1 style="font-size: 22px; text-align: center; padding-top: 15px; color: #105697;">How we support</h1>
        <ul>
          <li><img src="images/mdi-light_arrow-right (1).png" alt=""> <a href="">Individual Bookings</a></li>
          <li><img src="images/mdi-light_arrow-right (1).png" alt=""> <a href="">Group Bookings</a></li>
          <li><img src="images/mdi-light_arrow-right (1).png" alt=""> <a href="">One-off Bookings</a></li>
          <li><img src="images/mdi-light_arrow-right (1).png" alt=""> <a href="">Ongoing Bookings</a></li>
        </ul>
      </div>
    </div>
    <div class="col-md-12 col-lg-7 p-0">
      <img wi class="image" src="images/unsplash_p0qKsW3uqA4 (10).png" alt="Image">
    </div>
  </div>
    ...
    <div class="row gy-4">
      ...
      <div class="col-lg-2 col-md-6 col-sm-12 footer">
        ...
        <ul class="list-unstyled">
          ...
          <li><a class="fs-6 fw-light text" href="courses.html">Graphics Design</a></li>
          ...
          <li><a class="fs-6 fw-light text" href="courses.html">Animation</a></li>
          <li><a class="fs-6 fw-light text" href="courses.html">3D Modelling</a></li>
        </ul>
      </div>
