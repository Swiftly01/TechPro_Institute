...
<head>
  ...
  <link rel="stylesheet" href="styles/consultancy.css">
...
<body>
 ...
 <div  class="container">
  <div  class="row main">
    <div class="col">
      <h1 ><a class=" text-danger home" href="index.html">Home/</a><a class=" text-danger home" href="services.html">Services/</a><a class=" text-danger home" href="consultancy.html">IT Consultancy</a></h1>
    </div>
  </div>
  <div class="row">
    <div class="col">
  ...
  <div class="row no-gutters mt-5">
    <div style="background-color: #105697;" class="col-md-12 col-lg-5">
      ...
      <div class="links">
        ...
        <ul>
          <li><img src="images/mdi-light_arrow-right (1).png" alt=""> <a href="">Software Development</a></li>
          <li><img src="images/mdi-light_arrow-right (1).png" alt=""> <a href="">Cyber Security</a></li>
          <li><img src="images/mdi-light_arrow-right (1).png" alt=""> <a href="">Digital transformation</a></li>
          <li><img src="images/mdi-light_arrow-right (1).png" alt=""> <a href="">Digital Marketing</a></li>
        </ul>
      </div>
    </div>
    <div class="col-md-12 col-lg-7 p-0">
      <img class="image" src="images/unsplash_p0qKsW3uqA4-consult.png" alt="Image">
    </div>
  </div>
