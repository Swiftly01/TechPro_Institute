...
<body>
 ...
 <div  class="container">
  <div  class="row main">
    <div class="col">
      <h1  class="text-danger"><a class="text-danger" href="index.html">Home</a><a class="text-danger" href="services.html">/Services</a><a class="text-danger" href="incubation.html">/Incubation</a></h1>
    </div>
  </div> 
  <div class="row">
    <div class="col">
...
<div class="container">
  <div class="row">
    <div class="col-lg-6">
      <div class="links">
        <ul>
          ...
          <li><img  class="mb-1" src="images/mdi-light_arrow-right (1).png" alt=""> <a href="">Access to workstations</a></li>
          <li><img  class="mb-1" src="images/mdi-light_arrow-right (1).png" alt=""> <a href="">Workshop</a></li>
          <li><img  class="mb-1" src="images/mdi-light_arrow-right (1).png" alt=""> <a href="">Development Learn</a></li>
          <li><img  class="mb-1" src="images/mdi-light_arrow-right (1).png" alt=""> <a href="">Founding Oppurtunities</a></li>
          <li>
            <button onclick="window.location.href='about-u.html'" class="contact-btn" style="font-size: 14px;">Click here to tell us which incubation program you are interested in</button>
          </li>
        </ul>
      </div>
    ...
    <div class="col-lg-6">
      <div class="">
        <img class="img-fluid" src="images/unsplash_p0qKsW3uqA4.png" alt="">
      </div>
