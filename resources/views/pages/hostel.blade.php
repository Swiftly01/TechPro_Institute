...
<head>
  ...
  <link rel="stylesheet" href="styles/hostel.css">
...
<body>
 ...
 <div  class="container">
  <div  class="row main">
    <div class="col">
      <h1  class="text-danger"><a class="text-danger" href="">Home</a><a class="text-danger" href="">/Services</a><a class="text-danger" href="">/Hostel Facilities</a></h1>
  ...
  <div class="row no-gutters mt-5">
    <div style="background-color: #3F5F94;" class="col-md-12 col-lg-5 height">
      ...
      <div class="hostel-link">
        ...
        <ul>
          <li><img src="images/mdi-light_arrow-right (1).png" alt=""> <a href="">Whole Room</a></li>
          <li><img src="images/mdi-light_arrow-right (1).png" alt=""> <a href="">Bed Space</a></li>
          <li><img src="images/mdi-light_arrow-right (1).png" alt=""> <a href="">Common Room</a></li>
          <li><img src="images/mdi-light_arrow-right (1).png" alt=""> <a href="">Tv and Netflix</a></li>
          <li><img src="images/mdi-light_arrow-right (1).png" alt=""> <a href="">Internet</a></li>
        </ul>
      </div>
      <div>
        <div class="whole">
    ...
    <div style="background-color: #3F5F94;"  class="col-md-12 col-lg-7 p-0">
      <img class="image" src="images/DSC_4925.jpg" alt="Image">
    </div>
  </div>
