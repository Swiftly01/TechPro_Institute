 ...
 <div class="container">
  <div class="row">
    ...
    <div class="col-lg-8 col-md-12">
      <div class="row">
        <div class="col">
          <img src="images/DSC_4896.jpg" class="img-fluid" alt="">
        </div>
        <div class="col">
          <img width="100%" src="images/DSC_4914.jpg" class="img-fluid" alt="">
        </div>
      </div>

      <div class="row mt-4">
        <div class="col">
          <img src="images/DSC_4906.jpg" class="img-fluid" alt="">
        </div>
        <div class="col">
         <img width="100%" height="78%" src="images/DSC_4927.jpg" class="img-fluid" alt=""> 
        </div>
      </div>
    </div>
  </div>
