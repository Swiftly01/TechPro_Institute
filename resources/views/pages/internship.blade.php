...
<body>
 ...
 <div  class="container">
  <div  class="row main">
    <div class="col">
      <h1  class="text-danger"><a class="text-danger" href="index.html">Home</a><a class="text-danger" href="services.html">/Services</a><a class="text-danger" href="incubation.html">/Internship</a></h1>
    </div>
  </div> 
  <div class="row">
    <div class="col">
...
<div class="container">
  <div class="row">
    <div class="col-lg-6">
      <div class="links">
        <ul>
          ...
          <li><img  class="mb-1" src="images/mdi-light_arrow-right (1).png" alt=""> <a href="">3 Months</a></li>
          <li><img  class="mb-1" src="images/mdi-light_arrow-right (1).png" alt=""> <a href="">International Experience</a></li>
          <li><img  class="mb-1" src="images/mdi-light_arrow-right (1).png" alt=""> <a href="">Scrum Ceremonies</a></li>
          <li><img  class="mb-1" src="images/mdi-light_arrow-right (1).png" alt=""> <a href="">Collaboration</a></li>
          <li><img  class="mb-1" src="images/mdi-light_arrow-right (1).png" alt=""> <a href="">Reference</a></li>
        </ul>
      </div>
    ...
    <div class="col-lg-6">
      <div class="">
        <img class="img-fluid" src="images/unsplash_p0qKsW3uqA4 (internship).png" alt="">
      </div>
  ...
  <div class="container">
    <div class="row gy-4">
      ...
      <div class="col-lg-3 col-md-6 col-sm-12 footer">
        ...
        <p class="fs-6 fw-light text">E-mail: contact@techprong.com</p><p class="fs-6 fw-light text">Phone: 08086478810</p>
