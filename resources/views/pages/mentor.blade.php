...
<body>
 ...
 <div  class="container">
  <div  class="row main">
    <div class="col">
      <h1 ><a class=" text-danger home" href="index.html">Home/</a><a class=" text-danger home" href="services.html">Services/</a><a class=" text-danger home" href="mentoring.html">Mentoring</a></h1>
    </div>
  </div>
  <div class="row">
    <div class="col">
    ...
    <div style="background-color: #105697;" class="col-md-12 col-lg-5">
      ...
      <div class="links">
        ...
        <ul style="padding-bottom: 100px;">
          <li><img src="images/mdi-light_arrow-right (1).png" alt=""> <a href="">1 on 1 Sessions</a></li>
          <li><img src="images/mdi-light_arrow-right (1).png" alt=""> <a href="">Group Sesssion</a></li>
        </ul>
      </div>
    </div>
    <div class="col-md-12 col-lg-7 p-0">
      <img class="image" src="images/unsplash_p0qKsW3uqA4 (7).png" alt="Image">
    </div>
  </div>
