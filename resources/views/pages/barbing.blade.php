  ...
  <div class="container">
    <div class="row main">
      <div class="col">
        ...
        @endif
        <h1>
          <a class="text-danger home" href="index.html">Home/</a
          ><a class="text-danger home" href="services.html">Services/</a
          ><a class="text-danger home" href="mentoring.html">Barbing</a>
        </h1>
      </div>
    </div>
    <div class="row mt-1">
  ...
  <div class="container mt-4">
    <div style="background-color: whitesmoke" class="row">
      <div class="container">
        <div class="gallery-layout">
          ...
          <div
            id="carouselExample"
            class="carousel slide gallery-img"
            data-bs-ride="carousel"
          >
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img
                  src="{{asset('assets/images/DSC_4918.jpg')}}"
                  class="d-block w-100"
                  alt="Image 1"
                />
              </div>
              <div class="carousel-item">
                <img
                  src="{{asset('assets/images/DSC_4914.jpg')}}"
                  class="d-block w-100"
                  alt="Image 2"
                />
              </div>
              <div class="carousel-item">
                <img
                  src="{{asset('assets/images/DSC_4906.jpg')}}"
                  class="d-block w-100"
                  alt="Image 3"
                />
              </div>
              <div class="carousel-item">
                <img
                  src="{{asset('assets/images/DSC_4932.jpg')}}"
                  class="d-block w-100"
                  alt="Image 3"
                />
              </div>
          ...
          <div style="background-color: #0a5098; width: 30%">
            <div class="gallery-btn-layout">
              <a  class="gallery-btn" data-bs-toggle="modal" data-bs-target="#staticBackdrop"
                >Schedule Now</a
              >
            </div>
          </div>
    ...
    <div class="row">
      <div class="col text-center mt-0 mt-md-3">
        <a href="contact.html" class="schedule-btn">Tailored Cuts, Just for You</a>
      </div>
    </div>
    ...
    <form action="{{ route('services.barbing.create') }}" method="POST">
      ...
      <div class="modal-body">
          ...
          <div class="mb-3">
            ...
            <input value="{{ old('appointment_date') }}" name="appointment_date" type="date" class="form-control" id="date">
          ...
          <div class="mb-3">
            ...
            <input  value="{{ old('appointment_time') }}" type="time" id="timeInput" name="appointment_time" class="form-control" min="09:00" max="17:00">
