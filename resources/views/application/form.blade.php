...
<div   class="container">
  <div  class="row main">
    <div class="col">
      ...
      <h1 ><a class=" text-danger home" href="{{ url('/') }}">Home/</a><a class=" text-danger home">Application</a><a class=" text-danger home" href="{{ url('/outstanding') }}">/outstanding Payment</a></h1>
    </div>
  </div>
 </div> 
 ...
 <div class="container mt-5">
  <div style="background-color: whitesmoke;" class="row">
   ...
   <form action="{{ route('application.store.form') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            <label for="image_url" class="form-label  ms-5 label-name">Upload Pitch Deck</label>
